...
def main():
    ...
    out_dir = ensure_dir(str(results_root() / "forget_quality"))
    raw_dir = ensure_dir(str(results_root() / "forget_quality" / "raw"))
    ...
    logger.info("Done -> results/forget_quality/  "
                "(plot: python studies/strategy_comparison/plots/plot_forget_quality.py)")
