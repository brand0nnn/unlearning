...
=> the knowledge was only suppressed, not erased.
    ...
    python shared/plots/plot_relearn.py      # -> results/figures/relearn_forget_curve.png
"""
import json
import re
import sys
...
def main():
    ...
    ap.add_argument("--out", default="relearn_forget_curve.png",
                    help="output PNG name under --fig-dir")
    ap.add_argument("--fig-dir", default="results/figures",
                    help="directory to write the PNG into (a study's figures/ dir)")
