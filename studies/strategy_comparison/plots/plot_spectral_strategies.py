...
the fingerprint at the FINAL post-RMSNorm layer / SV1:
    ...
    python studies/strategy_comparison/plots/plot_spectral_strategies.py
...
def main():
    ...
    spectral_detectability(spec, str(FIGS), strategy_view=True, final_layer=True)
    spectral_signature_grid(spec, str(FIGS), strategy_view=True, final_layer=True)
