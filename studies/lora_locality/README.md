...
Outputs live under `studies/lora_locality/out/` (not the main `results/` folder); checkpoints
...
See the tables: `python studies/lora_locality/config.py`.
...
#    then inspect studies/lora_locality/out/fixedbudget/unlearn/*.json -> "matched" forget rouge
...
# 3. plot LOCALLY (rsync studies/lora_locality/out down first)
python studies/lora_locality/plot.py --scheme fixedbudget
```
