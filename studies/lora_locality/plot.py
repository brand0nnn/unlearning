...
scheme). Reads {_HERE}/out/<scheme>/recovery/*.json; writes into the same tree.

    python studies/lora_locality/plot.py --scheme fixedbudget
    python studies/lora_locality/plot.py --scheme samerank
"""
import argparse
import json
import sys
...
def main():
    ...
    rec_dir = Path(f"{_HERE}/out/{args.scheme}/{sub}")
