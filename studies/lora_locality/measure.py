...
{_HERE}/out/<scheme>/recovery/<location>.json.

    python studies/lora_locality/measure.py --checkpoint experiments/loc_fixedbudget_down \
...
from config import lora_params, SCHEMES
...
def main():
    ...
    out_dir = ensure_dir(f"{_HERE}/out/{args.scheme}/{sub}")
