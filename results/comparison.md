...
|---|---|---|---|---|---|
| reference | 0.723 | ~0.55 (Retain star) | — | — | — (reference) |
| gradient_ascent | 0.000 | -> 0 (destroyed) | 9.07e-08 | -7.0 | < 0.05 (log p ~ -20) |
| gradient_difference | 0.673 | preserved (higher) | 6.53e-167 | -166.2 | < 0.05 |
| idk | 0.316 | preserved (partial) | 1.12e-19 | -19.0 | < 0.05 |
| kl_minimization | 0.723 | preserved (higher) | 8.12e-27 | -26.1 | < 0.05 |
